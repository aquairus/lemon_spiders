...
dorp2_re = re.compile(r"<style.*?>|</style>|/style>|P|DIV|TD|TH|SPAN|FONT|UL|LI|A|\.|<h5>|</h5>|<h4>|</h4>|ShareFacebookEmailGoogle|LinkedInTwitter|<li.*?>|</li>|<ul.*?>|</ul>|</div>|<div .*?>")
dorp3_re = re.compile(r"<b>|</b>|<script.*?</script>")
