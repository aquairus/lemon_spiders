...
exp = re.compile(ur'(各|中國|中国|香港|华|新疆|華|台灣|臺灣|民國|朝).*')
list_exp = re.compile(ur'.*列表')
temp_exp = re.compile(ur'Template|要求|基督教|隊|·')
